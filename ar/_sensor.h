...
typedef enum {
    ...
    PIXFORMAT_GRAYSCALE, // 1BPP/GRAYSCALE //2
    PIXFORMAT_JPEG,      // JPEG/COMPRESSED //3
    PIXFORMAT_RGB888,    // 3BPP/RGB888 //4
    PIXFORMAT_RAW,       // RAW //5
    PIXFORMAT_RGB444,    // 3BP2P/RGB444 //6
    PIXFORMAT_RGB555,    // 3BP2P/RGB555 //7
} pixformat_t;
